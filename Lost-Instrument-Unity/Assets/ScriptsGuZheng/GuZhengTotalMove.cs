...
public class GuZhengTotalMove : MonoBehaviour
{
    ...
    void Update()
    {
        if (moveUp)
        {
            ...
            {
                moveUp = false;
                GameObject.Find("ShowImage").GetComponent<UIShowAndHideGuZheng>().Show();
            }
        }
        if(moveDown)
        {
    ...
    {
        GameObject.Find("ShowImage").GetComponent<UIShowAndHideGuZheng>().Hide();
        moveDown = true;
        startTime = Time.time;
